...
Run pyCave.exe to play the game.

If you can't run it, it is most likely that you need to install
the Microsoft Visua C++ redistributable. It is included within 
the distribution as vcredist_x86.exe.

For any other problem, contact me.
